class PercentChart {
    ...
    constructor(id, options) {
        ...
        if (temp_percent < 0 || temp_percent > 100)
            throw "ParameterError: percent parameter not between 0-100!";
        ...
        if (!(this.direction == "cw" || this.direction == "ccw"))
            throw "ParameterError: direction not either cw or ccw";
        ...
        <div class="pc-text ">
            <div class="pc-num">
                <span id="pc-percent" style="font-style: normal;font-weight: 600;font-size: 32px;line-height: 33px;text-align: center;color: #000000;"></span>
            </div>
        </div>
        `;
    ...
    render() {
        ...
        this.#chartText.children("#pc-unit").html(this.#data.unit);
        this.#chartSvg
            .children(".pc-fill")
            .css(
                "transition",
                `stroke-dasharray ${this.chartDuration} ${this.easing}`
            );
        setTimeout(
            () =>
                this.#chartSvg.children(".pc-fill").css({
                    "stroke-dasharray": `${this.#data.percent},100`,
                }),
            500
        );
    }
